...
export class Draw {
        ...
        if(this.game.State == "main"){
            ...
            for(let i = 0; i < this.game.menu.shopItems.length; i++){
                ...
                if(this.game.menu.shopItems[i].cost == -1){
                    color = "#555555"
                    this.DrawStroked(this.game.menu.shopItems[i].title + " : " + "Out Of Stock", (310-i*50)-(this.shopY/2 ),ything + (((ything)-450)*((ything)-450))/40, color, 10000, 80 + i*20 +(this.shopY/5 ))

                } else {
                    //this.DrawStroked(this.game.menu.shopItems[i].title + " : " + this.game.menu.shopItems[i].cost + "$", 310,450 + (100*i) + (this.shopY), color )
                    this.DrawStroked(this.game.menu.shopItems[i].title + " : " + this.game.menu.shopItems[i].cost + "$", (310-i*50)-(this.shopY/2 ),ything + (((ything)-450)*((ything)-450))/40, color, 10000, 80 + i*20 +(this.shopY/5 ))
                }
    ...
    DrawStroked(text, x, y, color = "white", width = 1500, size = 80) {
