...
export class Draw {
    ...
    Game() { // 
        ...
        if(this.debugInfo){
            this.DrawStroked(`${this.coinLog}`, 50, 850, "#90b0c0", 9999, 80, false, "#70a0b0")
            this.DrawStroked(`rgb(${this.cycleColorThingOne},${this.cycleColorThingThree},${this.cycleColorThingTwo})`, 50, 650, "#90b0c0", 9999, 80, false, "#70a0b0")
            this.DrawStroked(`X : ${Math.round(this.game.player.X)} + ${Math.round(this.game.player.velX)}   Y : ${Math.round(this.game.player.Y)} + ${Math.round(this.game.player.velY)}`, 50, 750, "#90b0c0", 9999, 80, false, "#70a0b0")
        }
    ...
    DrawStroked(text, x, y, color = "white", width = 1500, size = 80, shadow = true, stroke = "black") {
