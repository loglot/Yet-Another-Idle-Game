...
export class Menu{
    ...
    loadShop(){
        ...
        this.shopItems[this.shopItems.length] = new ShopItem("Magnetism", "the player is now a magnet, coins will follow you", 250, 1.2, "x", function func(){  this.game.player.magnetism += 100 }, this.game)
        this.shopItems[this.shopItems.length] = new ShopItem("Grow", "Grows the player slowly, what happens when you get to max size? nobody knows", 500, 2, "x", function func(){this.game.player.growSpeed *= 2 }, this.game)
        //this.shopItems[this.shopItems.length] = new ShopItem("Grow", "Grows the player, grow 7 times and see what happens", 0, 2, "x", function func(){ this.game.player.growSpeed += 1 }, this.game)
        ...
        this.shopItems[this.shopItems.length] = new ShopItem("null", "null", 0, 1, "x", function func(){ console.log(null) }, this.game)
        //this.shopItems[this.shopItems.length] = new ShopItem("free money", "null", 0, 1, "x", function func(){ this.game.Collected += 10000 }, this.game)
    ...
    tick(){
        ...
        if(this.game.keyMan.wasKeyJustPressed("ArrowUp") && this.game.State == "shop"){
            ...
            if(this.game.keyMan.isKeyPressed("Backslash")){
                this.shopItems[this.shopSelect].func()
            } else {
