...
export class Menu{
    ...
    loadShop(){
        this.shopItems = []
        this.shopItems[this.shopItems.length] = new ShopItem("Lava Speed Down", "reduces the rate at which lava gets made", 1, 1.5, "x", function func(){ this.game.player.damageTimeLimit += 50}, this.game)
