...
export class Menu{
    ...
    loadShop(){
        ...
        this.shopItems[this.shopItems.length] = new ShopItem("Grow", "Grows the player slowly, what happens when you get to max size? nobody knows", 500, 2, "x", function func(){ this.game.player.growSpeed += 1 }, this.game)
