...
export class Menu{
    ...
    constructor(game){
        this.game = game
        this.shopItems[this.shopItems.length] = new ShopItem("Coin Speed Up", "increses the rate at which coin and lava gets made slightly", 1, 1, "+", function func(){ this.game.player.coinSpeed += .3}, this.game)
        this.shopItems[this.shopItems.length] = new ShopItem("Coin Collection", "increses the amount of score you get from collecting a coin by one", 10, 2, "x", function func(){ this.game.player.coinAdd += 1}, this.game)
        this.shopItems[this.shopItems.length] = new ShopItem("Lava Insurance", "increses the amount of score you loose from collecting lava by one, (can go into the negatives)", 50, 2, "x", function func(){ this.game.player.lavaSubt -= 1}, this.game)
    }
