...
export class Menu{
    ...
    loadShop(){
        ...
        this.shopItems[this.shopItems.length] = new ShopItem("Magnetism", "the player is now a magnet, coins will follow you", 250, 1.2, "x", function func(){ this.game.player.growSpeed *= 2 }, this.game)
