...
export class Menu{
    ...
    loadShop(){
        this.shopItems = []
        this.shopItems[this.shopItems.length] = new ShopItem("Spawn Speed Up", "increses the rate at which coin and lava gets made slightly", 1, 1.3, "x", function func(){ this.game.player.coinSpeed += .3}, this.game)
        ...
        this.shopItems[this.shopItems.length] = new ShopItem("Lava Insurance", "increses the amount of score you loose from collecting lava by one, (can go into the negatives)", 50, 1.5, "x", function func(){ this.game.player.lavaSubt -= 1}, this.game)
        this.shopItems[this.shopItems.length] = new ShopItem("LB Speed", "increses the speed of the lava blaster", 50, 50, "+", function func(){ this.game.player.lavaKillTimerSpeed *= 2 }, this.game)
